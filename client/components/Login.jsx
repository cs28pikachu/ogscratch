...
const Login = (props) => {
  ...
  return (
    <div className="sign-in" >
      <a.div className="login-front" style={{ opacity: opacity.interpolate(o => 1 - o), transform }} onClick={() => set(1)}>
      ...
      <div id="failedLogin" className={hiddenClass}>Invalid Username/Password</div>
    </div>
  )
}
